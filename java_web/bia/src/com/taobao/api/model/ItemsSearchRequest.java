...
/**
 * 调用taobao.items.search搜索商品是 需要传入的参数
 * 
 * @author 
 * 
 */
public class ItemsSearchRequest extends TaobaoRequest{
	//
	private static final long serialVersionUID = 4665546097684832950L;
	private String q;
	...
	public ItemsSearchRequest withQ(String q) {
		setQ(q);
		return this;
	}

	public ItemsSearchRequest withStartPrice(String startPrice) {
		setStartPrice(startPrice);
		return this;
	}

	public ItemsSearchRequest withEndPrice(String endPrice) {
		setEndPrice(endPrice);
		return this;
	}

	public ItemsSearchRequest withCid(String cid) {
		setCid(cid);
		return this;
	}

	public ItemsSearchRequest withPageNo(Integer pageNo) {
		setPageNo(pageNo);
		return this;
	}

	public ItemsSearchRequest withPageSize(Integer pageSize) {
		setPageSize(pageSize);
		return this;
	}

	public ItemsSearchRequest withOrderBy(String orderBy) {
		setOrderBy(orderBy);
		return this;
	}

	public ItemsSearchRequest withFields(String fields) {
		setFields(fields);
		return this;
	}

	public ItemsSearchRequest withNicks(String nicks) {
		setNicks(nicks);
		return this;
	}
	...
	public ItemsSearchRequest withProps(String props) {
		setProps(props);
		return this;
	}
	
	public ItemsSearchRequest withProductId(String productId) {
		setProductId(productId);
		return this;
	}
	
	public ItemsSearchRequest withWwStatus(Boolean wwStatus) {
		setWwStatus(wwStatus);
		return this;
	}
	
	public ItemsSearchRequest withPostFree(Boolean postFree) {
		setPostFree(postFree);
		return this;
	}
	
	public ItemsSearchRequest withState(String state) {
		setState(state);
		return this;
	}
	
	public ItemsSearchRequest withCity(String city) {
		setCity(city);
		return this;
	}
	public ItemsSearchRequest withItemType(String itemType) {
	...
	public ItemsSearchRequest withIs3S(Boolean is3D) {
		setIs3D(is3D);
		return this;
	}
