 ...
 * 
 */
public class TaobaoAlisoftBaseRestClient extends TaobaoBaseRestClient {

	public TaobaoAlisoftBaseRestClient(String appkey, String secret)
	...
	public TaobaoAlisoftBaseRestClient(String serviceUrl, String appkey,
			String secret) throws TaobaoApiException {
		this(serviceUrl, "2.0", appkey, secret);
	}

	public TaobaoAlisoftBaseRestClient(String serviceUrl, String version,
			String appkey, String secret) throws TaobaoApiException {
		super(serviceUrl, version, appkey, secret, new LegacyTaobaoAlisoftJsonRestClient(serviceUrl, "1.0", appkey, secret));
		// Note, the legacy client always take 1.0 as version.
	}

	protected TaobaoAlisoftBaseRestClient(String serviceUrl, String version,
